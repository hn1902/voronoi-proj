#!/usr/bin/env python3
"""
Simplified DQN Agent for fixed Voronoi board
"""
...
class FixedDQN(nn.Module):
    """DQN for fixed-size Voronoi board"""
...
class FixedDQNAgent:
    """DQN Agent for fixed Voronoi Connect 4 board"""
    ...
    def __init__(self, state_size: int, action_size: int, lr: float = 0.001):
        ...
        # Neural networks
        self.q_network = FixedDQN(state_size, action_size).to(self.device)
        self.target_network = FixedDQN(state_size, action_size).to(self.device)
    ...
    def train_episode(self, env: fixed_rl_environment.FixedVoronoiRLEnvironment) -> float:
        """
    ...
    def evaluate_episode(self, env: fixed_rl_environment.FixedVoronoiRLEnvironment) -> Tuple[float, int, int]:
        """
...
class FixedVoronoiAI:
    """AI player that uses trained DQN agent for fixed board"""
    
    def __init__(self, agent: FixedDQNAgent, player_number: int = 2):
        self.agent = agent
        self.player_number = player_number
    
    def get_action(self, env: fixed_rl_environment.FixedVoronoiRLEnvironment) -> int:
        """
        Get AI's next move
    ...
    def make_move(self, env: fixed_rl_environment.FixedVoronoiRLEnvironment) -> Tuple[int, float, bool, dict]:
        """
